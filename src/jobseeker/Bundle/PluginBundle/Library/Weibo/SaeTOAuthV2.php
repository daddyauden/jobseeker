...
class SaeTOAuthV2 {
	 ...
	 * @ignore
	 */
	function revokeTokenURL()    { return 'https://api.weibo.com/oauth2/revokeoauth2'; }
	 ...
	 * @return array
	 */
	function getAuthorizeURL( $url, $response_type = 'code', $state = NULL, $scope = NULL, $display = NULL ) {
		$params = array();
	 ...
	 * access_token接口
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/Oauth2/revokeoauth2 Oauth2/revokeoauth2}
	 *
	 * @param string $token
	 * @return boolean
	 */
